...
export default function Home() {
  ...
  useEffect(() => {
    ...
    animateValue(0, 1542, 2000, (val) => setStats(prev => ({ ...prev, users: val })));
    animateValue(0, 28743, 2500, (val) => setStats(prev => ({ ...prev, messages: val })));
    animateValue(0, 89, 1500, (val) => setStats(prev => ({ ...prev, online: val })));
  }, []);
